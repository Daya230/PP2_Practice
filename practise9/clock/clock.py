...
def run_clock():
    ...
    image_clock = pygame.image.load(r"C:\study\PP2\githowto\repositories\work\practise9\clock\images\clock.png").convert_alpha()
    image_clock = pygame.transform.scale(image_clock, (750, 600))

    mickey = pygame.image.load(r"C:\study\PP2\githowto\repositories\work\practise9\clock\images\mickey.png").convert_alpha()
    mickey = pygame.transform.scale(mickey, (400, 280))

    hand_left = pygame.image.load(r"C:\study\PP2\githowto\repositories\work\practise9\clock\images\left_hand.png").convert_alpha()
    hand_left = pygame.transform.scale(hand_left, (150, 190))

    hand_right = pygame.image.load(r"C:\study\PP2\githowto\repositories\work\practise9\clock\images\right_hand.png").convert_alpha()
